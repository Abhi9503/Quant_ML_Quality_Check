...
//     const {data}= useFrappeGetDocList<ProductList>('Product Information',{fields:["name","product_name","product_group","status","image"]})
//     // const { data } = useFrappeGetDocList<ProductList>('Product Information', { fields: ["name", "product_name", "product_group", "status", "image"] }) || { data: [] };
...
//                             <h1 className="font-extrabold text-xl md:text-2xl lg:text-3xl xl:text-4xl  inline-block my-auto mt-10">QUALITY CHECK</h1>
//                         </div>
...
//                                 >
//                                     <option className="text-blue-400">Select Product ID</option>
//                                     {data && data.map((item) => (
//                                         <option key={item.name} value={item.name}>
//                                             {item.name}
//                                         </option>
...
//                     </div>
//                     {selectImage.trim() !== "" && (
//                         <img className="mt-10 md:mt-0 object-cover w-1/2 rounded-t-lg h-auto md:h-1/2 md:rounded-none md:rounded-s-lg" src={selectImage} alt="Product Image" />
//                     )}
//                 </div>
...
const Cheakquality = () => {
  ...
  return (
    <>
      <Header />
            <div className="mt-10 mx-auto max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl ">
            <div className="mx-auto w-3/4 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row  hover:bg-gray-100">
                <div className="w-auto md:w-1/2">
                    <div className="text-center mt-10 lg:mt-0">
                        <h1 className="font-extrabold text-xl md:text-2xl lg:text-3xl xl:text-4xl  inline-block my-auto mt-10">QUALITY CHECK</h1>
                    </div>
