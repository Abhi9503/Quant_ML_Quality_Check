...
//   return (
//     <>
//         <div class="m-10 md:w-1/2">
//         <label
//             for="formFileLg"
//             class="mb-2 inline-block text-neutral-700 dark:text-neutral-200">Traning Dataset</label>
//         <input
...
const FolderInput = () => {
  const handleFolderChange = (event) => {
    ...
    // You can now handle the selected folder as needed
  };
